    ...
    return (
        <div className={'card '+ classes.formContainer}>
            ...
            <div style={{display:'flex',flexDirection:'row', width:'97%', marginTop:'7.7vh', justifyContent:'center', height:'4.5vh', backgroundColor:'rgb(23 116 227)', color:'white' /*color:'#eeee5f'*/, alignSelf:'center', alignItems:'center', borderRadius:7}}> 
                ...
                <div style={{width:'7vw', marginRight:'2vw'}}><b style ={{textTransform:'uppercase'}}>{currentUiContext.formInputs[3]}44hg5885</b></div>
            ...
            { (()=>{
                    ...
                    ligne.push(<div key="titre" style={{display:'flex',flexDirection:'row',marginLeft:'2vw'}}><div style={{width:'10vw'}}><b >Libelle</b></div><div style={{width:'10vw'}}><b>Versé</b></div><div style={{width:'10vw'}}><b>Attendu</b></div><div style={{width:'10vw'}}><b>Date Deb</b></div><div style={{width:'10vw'}}><b>Date Fin</b></div></div>)
                    for(let i=0;i<n;i++){
                    ...
                    ligne.push(<br />)
                        ...
                        if(reste>0)
                            ligne.push(<div key={"tranche_recap"} style={{marginTop:'-3.3vh', display:'flex',flexDirection:'row', marginLeft:"15.3vw", width:"33vw", backgroundColor:'lightgrey'}}>
                                <div style={{width:'10vw', marginTop:'0.7vh'}}><b>Totaux</b></div>
                                <div style={{width:'10vw', fontSize:'0.93vw', marginTop:'0.7vh', marginLeft:'1vw'}}> <i>Versé :</i></div>
                                <div style={{width:'10vw',fontSize:'1.1em',color:'green', marginLeft:'-1.7vw'}}><b> {montantVerse}</b></div>
                                <div style={{width:'10vw', fontSize:'0.93vw', marginTop:'0.7vh', marginLeft:'1vw'}}> <i>Attendu :</i></div>
                                <div style={{width:'10vw', marginLeft:'-0.77vw', marginTop:'0.57vh'}}><b>{a_payer}</b></div>
                                <div style={{width:'10vw', fontSize:'0.93vw', marginTop:'0.7vh', marginLeft:'1vw'}}> <i>Reste :</i></div>
                            ...
                            if(currentUiContext.formInputs[8]!==""){
                                ...
                                ligne.push(<div key="historique" style={{display:'flex',flexDirection:'row',marginLeft:"2vw"}}><div style={{color:'blue',textAlign:'center'}}><b><i>Historique des payements:</i></b></div></div>)
                                ligne.push(<div key="recap" style={{display:'flex',flexDirection:'row', marginLeft:"2vw"}}><div style={{width:'33vw'}}><b>Montant versé</b></div><div style={{width:'33vw'}}><b>Date payement</b></div></div>)
                            }
                        ...
                        (props.formMode!='consult') ?
                            <div className={classes.inputRowLeft}> 
                                <div style={{marginLeft:'10vw', width:'15vw'}}>
                                    <b>Saisir le Montant à verser :  </b>
                                </div>
            ...
            <div className={classes.buttonRow} style={{alignSelf:'center', width:'27vw'}}>
                ...
                <CustomButton
                    btnText={(props.formMode=='creation') ? 'Valider':'Enregistrer'} 
                    buttonStyle={getButtonStyle()}
                    btnTextStyle = {classes.btnTextStyle}
