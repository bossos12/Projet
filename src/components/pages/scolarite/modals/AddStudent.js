...
function AddStudent(props) {
    ...
    function formDataCheck3(eleve){       
        ...
        if((eleve.tel_mere.length >0 && isNaN(eleve.tel_mere.replace(/\s/g,'')))||(eleve.tel_pere.length >0 && isNaN(eleve.tel_pere.replace(/\s/g,''))) ){
            errorMsg="Le numero de telephone d'un des parents n'est pas correct !";
            console.log(eleve.tel_mere.replace(/\s/g,''))
            return errorMsg;
        }
        return errorMsg;  
    }
        ...
        <div className={'card '+ classes.formContainer}>
            <div className={getCurrentHeaderTheme()}>
                ...
                {(props.formMode == 'creation')  ?                
                    <div className={classes.formMainTitle} >
                        {t("ENREGISTREMENT D'UN NOUVEL ELEVE")}
                    </div>
                : (props.formMode == 'modif') ?
                    <div className={classes.formMainTitle} >
                       {t("MODIFICATION DES INFORMATIONS D'UN ELEVE")} 
                    </div>
                :
                    <div className={classes.formMainTitle} >
                       {t("CONSULTATION DES INFORMATIONS SUR UN ELEVE")}
                    </div>
            ...
            {(etape == 1) &&
                <div id="AjoutEleveEtape1" className={classes.etape} /*onLoad={()=>{moveToLeft()}}*/>
                    ...
                    <div className={classes.inputRow}>
                        <div className={classes.groupInfo} >
                            ...
                            <div className={classes.inputRowLeft}> 
                                ...
                                {(props.formMode =='consult') ?
                                    <div> 
                                        <input id="date_naissance" type="text" className={classes.inputRowControl}  defaultValue={currentUiContext.formInputs[2]} style={{width:'6vw', height:'1.3rem', marginLeft:'-2vw'}}/>
                                    </div>
                                    :
                                    ...
                                    <div style ={{display:'flex', flexDirection:'row'}}> 
                                        ...
                                        <input id="anne" type="text"    Placeholder='aaaa'  onKeyUp={(e)=>{moveOnMax(e,document.getElementById("anne"), document.getElementById("lieu_naissance"))}}  maxLength={4}   className={classes.inputRowControl }  style={{width:'2.7vw', height:'1.3rem', marginLeft:'0vw'}}  />
                                    </div>
                                    :
                                    <div style ={{display:'flex', flexDirection:'row'}}> 
                                        ...
                                        <input id="anne" type="text"  maxLength={4}   onKeyUp={(e)=>{moveOnMax(e,document.getElementById("anne"), document.getElementById("lieu_naissance"))}} className={classes.inputRowControl}  style={{width:'2.7vw', height:'1.3rem', marginLeft:'0vw'}}  defaultValue={currentUiContext.formInputs[2].split("/")[2]} />
                                    </div>
                                }
                            </div>
                            ...
                            <div className={classes.inputRowLeft}> 
                                ...
                                <div style={{display:'flex', flexDirection:'row',  marginLeft:"-2.3vw"}}>
                                    <label style={{color:'black', marginLeft:'0.13vw', marginRight:"0.3vw",marginTop:"0.23vw" }}>Masculin </label>
                                    <input type='radio' checked={isMasculin==true}  value={'presents'} name='profpresents' onClick={()=>{isMasculin? setIsMasculin(false):setIsMasculin(true)}}/>

                                    <label style={{color:'black', marginLeft:'0.13vw', marginRight:"0.3vw", marginLeft:"1.3vw", marginTop:"0.23vw"}}>Feminin </label>
                                    <input type='radio' checked={isMasculin==false}  value={'presents'} name='profpresents' onClick={()=>{isMasculin? setIsMasculin(false):setIsMasculin(true)}}/>
                                </div>                     
                            </div>
                        </div>
                    ...
                    {(props.formMode != 'consult') &&
                        <div className={classes.inputRowRight} style={{position:'absolute', bottom:'1vh'}}>
                            <CustomButton
                                btnText='Annuler' 
                ...
                <div id='AjoutEleveEtape2' className={classes.etape} /*onLoad={()=>{document.getElementById("AjoutEleveEtape2").classList.add('gotoLeft');}}*/>
                    ...
                    <div className={classes.groupInfo} style={{marginBottom:'3.7vh'}}>
                        ...
                        <div className={classes.inputRowLeft}> 
                            ...
                            <div style={{display:'flex', flexDirection:'row',  marginLeft:"-2.3vw"}}>
                                <label style={{color:'black', marginLeft:'0.13vw', marginRight:"0.3vw", marginLeft:"1.3vw", marginTop:"0.23vw"}}>Non </label>
                                ...
                                <label style={{color:'black', marginLeft:'0.13vw', marginRight:"0.3vw",marginTop:"0.23vw" }}>Oui </label>
            ...
            {(etape == 3) &&
                <div id='AjoutEleveEtape3' className={classes.etape} /*onLoad={()=>{document.getElementById("AjoutEleveEtape3").classList.add('gotoLeft');}}*/>
                    <div className={classes.inputRowLeft} style={{color:'rgb(185, 131, 14)', fontFamily:'Roboto, sans-serif', fontWeight:570, fontSize:'1.27vw', borderBottomStyle:'solid', borderBottomColor:'rgb(185, 131, 14)', borderBottomWidth:1.97, marginBottom:'3vh'}}> 
                        Etape 3: Saisi des informations des parents de l'eleve
                        {(props.formMode=='consult')&&
                            <div style={{position:'absolute', right:0, top:'-0.7vh' }}>
                                <CustomButton
                                    btnText='Quitter' 
