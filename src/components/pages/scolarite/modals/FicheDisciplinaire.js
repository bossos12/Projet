        ...
        return(
            <div style={{display:'flex', color:props.isHeader ?'white':'black', backgroundColor: props.isHeader ?'rgb(6, 83, 134)':'white', flexDirection:'row', height: props.isHeader ?'3vh':'3.7vh', width:'40vw', fontSize:'0.87vw', alignItems:'center', borderBottomStyle:'solid', borderBottomWidth:'1px', borderBottomColor:'black', borderTopStyle:'solid', borderTopWidth:'1px', borderTopColor:'black'}}>
                ...
                <div style={{width:'7vw', marginLeft:'1vw', color: props.isHeader? 'white':'blue', cursor: props.isHeader? 'default' :'pointer' }}>
                    {props.isHeader ? 'Action'
                        : props.nonJustifie >0 ? <input type="text" value='Justifier' style={{color:'blue', fontSize:'0.87vw', fontWeight:'700', cursor:'pointer'}} onClick={showJustifPopup} /> : null                      
                    }
                </div>
    ...
    const LigneTotauxAbsences=(props)=>{
        return(
            <div style={{display:'flex', color:'black', alignSelf:'flex-end', marginRight:'2.83vw', backgroundColor:'lightgray', flexDirection:'row', height:'3vh', width:'30vw', fontSize:'0.87vw', alignItems:'center', borderBottomStyle:'solid', borderBottomWidth:'1px', borderBottomColor:'black', borderTopStyle:'solid', borderTopWidth:'1px', borderTopColor:'black'}}>
                <div style={{width:'10vw',  fontWeight:'700'}}>{'Totaux'}</div>
                <div style={{width:'7vw',  fontWeight:'700'}}>Heures :{props.totalHeures}</div>
                <div style={{width:'7vw', color:props.isHeader?'white':'green', fontWeight:'700'}}>Justifie : {props.totalJustifie}</div>
                <div style={{width:'7vw', color:props.isHeader?'white':'red', fontWeight:'700'  }}>Non justifie: {props.totalNonjustife}</div>
            </div>
        );
    }
    ...
    const LignePunitionHeader=(props)=>{
        return(
            <div style={{display:'flex', color:'white', backgroundColor:'rgb(6, 83, 134)', flexDirection:'row', height:'3vh', width:'40vw', fontSize:'0.87vw', alignItems:'center', borderBottomStyle:'solid', borderBottomWidth:'1px', borderBottomColor:'black', borderTopStyle:'solid', borderTopWidth:'1px', borderTopColor:'black'}}>
                <div style={{width:'5.7vw'}}>{'Date'}</div>
                <div style={{width:'4vw'}}>{(props.punitionCode==1) ? 'Jours':'Heures' }</div>
                {(props.punitionCode==1||props.punitionCode==11)&&     //0-> Consigne, 1->Exclusion temporaire, 11->Exclusion Definitive, 2->Autre
                    <div style={{width:'4vw'}}>{'definitive'}</div>
                }
                <div style={{width:'15vw'}}>{'Motif'}</div>
                <div style={{width:'7vw'}}>{'Etat actuel'}</div>
                <div style={{width:'3vw'}}>{'Action'}</div>                 
                <div style={{width:'3vw'}}/>                    
            </div>
        );
    }
    ...
    const LignePunition=(props)=>{
        return(
            <div style={{display:'flex', color: props.isHeader ?'white':'black', backgroundColor: props.isHeader ?'rgb(6, 83, 134)':'white', flexDirection:'row', height: props.isHeader ?'3vh':'3.7vh', width:'40vw', fontSize:'0.87vw', alignItems:'center', borderBottomStyle:'solid', borderBottomWidth:'1px', borderBottomColor:'black', borderTopStyle:'solid', borderTopWidth:'1px', borderTopColor:'black'}}>
                ...
                <div style={{width:'4vw'}}> <input  disabled={gridConsignes[props.rowIndex].etat>0}   id={'NbJoursCons_'+props.rowIndex} onChange={(e)=>{cur_punitionDuree = e.target.value;}} type='text' placeholder='Nbre' style={{height:'1.4rem', fontSize:'0.87vw', paddingTop:'1.3vh'}} defaultValue={props.nbreJours}/></div>
                ...
                <div style={{width:'15vw'}}> <input disabled={gridConsignes[props.rowIndex].etat>0}  id={'motifCons_'+props.rowIndex} onChange={(e)=>{cur_punitionMotif = e.target.value;}} type='text' placeholder='Saisir le motif ' style={{height:'1.4rem', fontSize:'0.87vw', paddingTop:'1.3vh'}} defaultValue={props.motif}/></div>
                <div style={{width:'7vw', fontWeight:'700'}}>
                    <label id={props.rowIndex} style={{ color:gridConsignes[props.rowIndex].etat < 2?'red':'green', height:'1.4rem', fontSize:'0.87vw', paddingTop:'1.3vh', cursor:'pointer', fontWeight:'700'}} onClick={gridConsignes[props.rowIndex].etat==0 ? props.EnregPunition : gridConsignes[props.rowIndex].etat==1 ? props.doPunition : null}>{gridConsignes[props.rowIndex].etat==0 ?'Enregistrer' : gridConsignes[props.rowIndex].etat ==1&&props.punitionCode!=11 ? 'A effectuer' :gridConsignes[props.rowIndex].etat >1 && props.punitionCode!=11 ? 'Effectuee':null}</label>
                </div>
                <div style={{width:'3vw'}}> 
    ...
    const LignePunitionExcl=(props)=>{
        return(
            <div style={{display:'flex', color: props.isHeader ?'white':'black', backgroundColor: props.isHeader ?'rgb(6, 83, 134)':'white', flexDirection:'row', height: props.isHeader ?'3vh':'3.7vh', width:'40vw', fontSize:'0.87vw', alignItems:'center', borderBottomStyle:'solid', borderBottomWidth:'1px', borderBottomColor:'black', borderTopStyle:'solid', borderTopWidth:'1px', borderTopColor:'black'}}>
                ...
                <div style={{width:'4vw'}}> <input  disabled={gridExclusions[props.rowIndex].etat>0}   id={'NbJoursExcl_'+props.rowIndex} onChange={(e)=>{cur_punitionDuree = e.target.value;}} type='text' placeholder='Nbre' style={{height:'1.4rem', fontSize:'0.87vw', paddingTop:'1.3vh'}} defaultValue={props.nbreJours}/></div>
                {(props.punitionCode==1||props.punitionCode==11)&&
                ...
                <div style={{width:'15vw'}}> <input disabled={gridExclusions[props.rowIndex].etat>0}  id={'motifExcl_'+props.rowIndex} onChange={(e)=>{cur_punitionMotif = e.target.value;}} type='text' placeholder='Saisir le motif ' style={{height:'1.4rem', fontSize:'0.87vw', paddingTop:'1.3vh'}} defaultValue={props.motif}/></div>
                <div style={{width:'7vw', fontWeight:'700'}}>
                    <label id={props.rowIndex} onClick={gridExclusions[props.rowIndex].etat==0 ? props.EnregPunition : gridExclusions[props.rowIndex].etat==1 ? props.doPunition : null} style={{ color:gridExclusions[props.rowIndex].etat < 2?'red':'green', height:'1.4rem', fontSize:'0.87vw', paddingTop:'1.3vh', cursor:'pointer', fontWeight:'700'}} >{gridExclusions[props.rowIndex].etat==0 ?'Enregistrer' : gridExclusions[props.rowIndex].etat ==1&&props.punitionCode!=11 ? 'A effectuer' :gridExclusions[props.rowIndex].etat >1 && props.punitionCode!=11 ? 'Effectuee':null}</label>
                </div>
                <div style={{width:'3vw'}}> 
    ...
    const LignePunitionOth=(props)=>{
        return(
            <div style={{display:'flex', color: props.isHeader ?'white':'black', backgroundColor: props.isHeader ?'rgb(6, 83, 134)':'white', flexDirection:'row', height: props.isHeader ?'3vh':'3.7vh', width:'40vw', fontSize:'0.87vw', alignItems:'center', borderBottomStyle:'solid', borderBottomWidth:'1px', borderBottomColor:'black', borderTopStyle:'solid', borderTopWidth:'1px', borderTopColor:'black'}}>
                ...
                <div style={{width:'4vw'}}> <input  disabled={gridOther[props.rowIndex].etat>0}   id={'NbJoursOthr_'+props.rowIndex} onChange={(e)=>{cur_punitionDuree = e.target.value;}} type='text' placeholder='Nbre' style={{height:'1.4rem', fontSize:'0.87vw', paddingTop:'1.3vh'}} defaultValue={props.nbreJours}/></div>
                {(props.punitionCode==1||props.punitionCode==11)&&
                ...
                <div style={{width:'15vw'}}> <input disabled={gridOther[props.rowIndex].etat>0}  id={'motifOthr_'+props.rowIndex} onChange={(e)=>{cur_punitionMotif = e.target.value;}} type='text' placeholder='Saisir le motif ' style={{height:'1.4rem', fontSize:'0.87vw', paddingTop:'1.3vh'}} defaultValue={props.motif}/></div>
                <div style={{width:'7vw', fontWeight:'700'}}>
                    <label id={props.rowIndex} onClick={gridOther[props.rowIndex].etat==0 ? props.EnregPunition : gridOther[props.rowIndex].etat==1 ? props.doPunition : null} style={{ color:gridOther[props.rowIndex].etat < 2?'red':'green', height:'1.4rem', fontSize:'0.87vw', paddingTop:'1.3vh', cursor:'pointer', fontWeight:'700'}} >{gridOther[props.rowIndex].etat==0 ?'Enregistrer' : gridOther[props.rowIndex].etat ==1&&props.punitionCode!=11 ? 'A effectuer' :gridOther[props.rowIndex].etat >1 && props.punitionCode!=11 ? 'Effectuee':null}</label>
                ...
                <div className={classes.etapeP} style={{overflowY:'scroll', height:'75vh'}}>
                    <div className={classes.inputRow} style={{marginBottom:'1.3vh'}}> 
                        <div style={{marginLeft:'-4vw'}}>
                            <img alt='student' className={classes.photoStyleP} src={'images/profile.png'}/>
                        </div>   
                       
                        <div className={classes.studentInfo}  style={{marginRight:'-3.7vw', marginLeft:'1vw'}}>
                            <div style={{display:'flex', flexDirection:'row', justifyContent:'flex-start'}}>
                               <div style={{fontWeight:'700', marginRight:'0.3vw'}}> NOM : </div> <div> ADAMA KOUATOU Emmanuel</div>
                            </div>

                            <div style={{display:'flex', flexDirection:'row', justifyContent:'flex-start'}}>
                                <div style={{fontWeight:'700', marginRight:'0.3vw'}}> CLASSE : </div> <div> 6eA1</div>
                                <div style={{fontWeight:'700', marginRight:'0.3vw', marginLeft:'3vw'}}> MATRICULE : </div> <div> 02JHGF85H</div>
                            </div>
                            <div style={{display:'flex', flexDirection:'row', justifyContent:'flex-start'}}>
                                <div style={{fontWeight:'700', marginRight:'0.3vw'}}> AGE : </div> <div> 10 ans</div>
                                <div style={{fontWeight:'700', marginRight:'0.3vw', marginLeft:'4.3vw'}}> REDOUBLE  : </div> <div> Non</div>
                            </div>
                        </div>
                    ...
                    <div style={{display:'flex', flexDirection:'column', justifyContent:'center', height:'20vh'}}>
                        ...
                        <div style={{display:'flex', flexDirection:'column', marginTop:'0.7vh', marginLeft:'2vw',overflowY:'scroll', justifyContent:'center'}}>
                            <LigneAbsence date={'Date'} nbreHeure={'Nbre Heure'} nbreJustifie={'Justifie'} nonJustifie={'Non Justifie'} isHeader={true}/>
