...
function AddDisciplinMeeting(props) {
   ...
   /* function getListCasParCas(){
    ...
    function setFormData2(){
        ...
        setOptConvoques([...getElevesTab(tabEleves)]);
    ...
    function getMotif(motifId){
        switch(motifId){
            case 0: return 'Absence';
            case 1: return 'Conduite';
            case 2: return 'Autre'
    ...
    const LigneEleveHeader=(props)=>{
        return(
            <div style={{display:'flex', color:'white', backgroundColor:'rgb(6, 83, 134)', flexDirection:'row', height:'3vh', width:'40vw', fontSize:'0.87vw', alignItems:'center', borderBottomStyle:'solid', borderBottomWidth:'1px', borderBottomColor:'black', borderTopStyle:'solid', borderTopWidth:'1px', borderTopColor:'black'}}>
                <div style={{width:'17vw'}}>{"Nom"}</div>
                <div style={{width:'30vw'}}>{"Motif"}</div>
                <div style={{width:'7vw', marginLeft:'1.7vw'}}>{"Action"}</div>
            </div>
        );
    }
                ...
                {(props.etat >= 0) ?
                   ...
                   :
                        <div style={{display:'flex',  flexDirection:'row',   width:'30vw', alignItems:'center'}}> 
                            ...
                            <label style={{ color:'black', fontWeight:"bold", fontSize:"0.77vw", marginLeft:'0.13vw', marginRight:"1vw"}}>Absences </label>
                            ...
                            <label style={{ width:'2vw', color:'black',  fontWeight:"bold", fontSize:"0.77vw", marginRight:"2vw", marginLeft:"0.3vw"}}>Conduite </label>
                            ...
                            <label style={{width:'2vw', color:'black', fontWeight:"bold", fontSize:"0.77vw", marginLeft:'0.13vw', marginRight:"1vw"}}>Autre</label>
   ...
   /* function addEleveRow(){
    ...
    function getDecision(decisionId){
        switch(decisionId){
            ...
            case 2: return 'Exclusion temporaire'
            case 3: return 'Exclusion definitive'
            default: return 'Autre';
        }
                ...
                {(props.etat == 1) ?
                   ...
                   :
                        <div style={{display:'flex',  flexDirection:'row',   width:'30vw', alignItems:'center'}}> 
                            ...
                            <label style={{ color:'black', fontWeight:"bold", fontSize:"0.77vw", marginLeft:'0.13vw', marginRight:"1vw"}}>Aucune </label>
                            ...
                            <label style={{ width:'2vw', color:'black',  fontWeight:"bold", fontSize:"0.77vw", marginRight:"2vw", marginLeft:"0.3vw"}}>Consigne </label>
                            ...
                            <label style={{width:'3.3vw', color:'black', fontWeight:"bold", fontSize:"0.77vw", marginLeft:'0.13vw', marginRight:"1vw" }}>{'Excl.temp.'}</label>
                            ...
                            <label style={{width:'3.3vw', color:'black', fontWeight:"bold", fontSize:"0.77vw", marginLeft:'0.13vw', marginRight:"1vw"}}>{'Excl.def.'} </label>
            ...
            <div className={getCurrentHeaderTheme()}>
                ...
                {(props.formMode == 'creation')  ?                
                    <div className={classes.formMainTitle} >
                            CREATION D'UN CONSEIL DE DISCIPLINE
                    </div>
                : (props.formMode == 'modif') ?
                    <div className={classes.formMainTitle} >
                        MODIFICATION D'UN CONSEIL DE DISCIPLINE
                    </div>
                :
                    <div className={classes.formMainTitle} >
                       CONSULTATION D'UN CONSEIL DE DISCIPLINE
                    </div>
                        ...
                        <div className={classes.groupInfo} style={{fontSize:'1vw'}}>
                            ...
                            <div className={classes.inputRowLeft} style={{height:'4.7vh'}}> 
                                ...
                                {(props.formMode =='consult') ?
                                    ...
                                    <div style ={{display:'flex', flexDirection:'row'}}> 
                                        ...
                                        <input id="min"  type="text"    Placeholder='mm'   onKeyUp={(e)=>{moveOnMax(e,document.getElementById("min"), null)}}                                maxLength={2}   className={classes.inputRowControl }  style={{width:'1.7vw', height:'1.3rem', marginLeft:'0vw'}}  /><b>min</b>
                                    </div>
                                    :
                                    <div style ={{display:'flex', flexDirection:'row'}}> 
                                        ...
                                        <input id="min"  type="text"   maxLength={2}  onKeyUp={(e)=>{moveOnMax(e,document.getElementById("min"), null)}}                                  className={classes.inputRowControl}  style={{width:'1.7vw', height:'1.3rem', marginLeft:'0vw'}}   defaultValue={currentUiContext.formInputs[3].split(":")[1]} /><b>min</b>
                                    </div>
                                }
                           ...
                           {/*<div className={classes.inputRowLeft} style={{height:'4.7vh'}}> 
                                ...
                                {(props.formMode =='consult') ?
                                    ...
                                    <select id='objet' defaultValue={1} onChange={objetChangeHandler} className={classes.comboBoxStyle} style={{marginLeft:'-2vw', height:'1.73rem',width:'15vw'}}>
                                        {(optObjet||[]).map((option)=> {
                                            return(
                                                <option  value={option.value}>{option.label}</option>
                                            );
                            ...
                            <div style={{display:'flex', flexDirection:'column', justifyContent:'flex-start', height:'19.3vh', marginLeft:'-2vw'}}>
                                <div style={{display:'flex', flexDirection:'row', justifyContent:'space-between', fontSize:'1vw', fontWeight:'bold', marginBottom:'0vh', marginLeft:'0vw', width:'97%'}}>
                                    <FormPuce menuItemId ='1' 
                                        ...
                                        withCustomImage={true} 
                                        imageStyle={classes.PuceStyle}    
                                        libelle = {'Liste des eleves convoques'}   
                                        itemSelected={null}
                            ...
                            <div style={{display:'flex', flexDirection:'column', justifyContent:'flex-start', height:'23vh', marginLeft:'-2vw'}}>
                                <div style={{display:'flex', flexDirection:'row', justifyContent:'space-between', fontSize:'1vw', fontWeight:'bold', marginBottom:'0vh', marginLeft:'0vw', width:'97%'}}>
                                    <FormPuce menuItemId ='1' 
                                        ...
                                        withCustomImage={true} 
                                        imageStyle={classes.PuceStyle}    
                                        libelle = {'Liste des profs participants'}   
                                        itemSelected={null}
                                        style={{marginBottom:'-1vh'}}
                                        puceImgStyle={{marginRight:'-0.3vw', marginTop:'1vh'}}
                                    />  
