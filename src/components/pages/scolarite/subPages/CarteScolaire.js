...
import CardTemplate from "../reports/CardTemplate";
import CardListTemplate from "../reports/CardListTemplate";
...
/*************************** Handler functions ***************************/
    ...
    return (
        <div className={classes.formStyleP}>
            ...
            {(modalOpen==4) &&  <PDFTemplate previewCloseHandler={closePreview}><PDFViewer style={{height: "80vh" , width: "100%" , display:'flex', flexDirection:'column', justifyContent:'center',  display: "flex"}}><CardListTemplate pageSet={ElevePageSet}/></PDFViewer></PDFTemplate>} 
