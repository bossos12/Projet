...
const conseil_data =[
    {id:1, date:'12/05/2023', heure:'12:45', objetId:1, objetLabel:'Bilan sequentiel', responsableId:1, responsableLabel:'Mr MBALLA Alfred', profPrincipalLabel:'Mr MBARGA Alphonse',     etat:0,  etatLabel:  'En cours' },
    {id:2, date:'18/05/2023', heure:'08:45', objetId:1, objetLabel:'Bilan sequentiel', responsableId:2, responsableLabel:'Mr TOWA Luc', profPrincipalLabel:'Mr MBARGA Alphonse',          etat:0,  etatLabel:  'En cours' },
    {id:3, date:'02/05/2023', heure:'09:30', objetId:1, objetLabel:'Bilan sequentiel', responsableId:3, responsableLabel:'Mr OBATE Simplice', profPrincipalLabel:'Mr MBARGA Alphonse',    etat:0,  etatLabel:  'En cours' },
    {id:4, date:'17/05/2023', heure:'15:45', objetId:1, objetLabel:'Bilan sequentiel', responsableId:4, responsableLabel:'Mr TSALA Pascal', profPrincipalLabel:'Mr MBARGA Alphonse',      etat:1,  etatLabel:  'Cloture'  },
    {id:5, date:'03/05/2023', heure:'10:20', objetId:1, objetLabel:'Bilan sequentiel', responsableId:5, responsableLabel:'Mr TCHIALEU Hugues', profPrincipalLabel:'Mr MBARGA Alphonse',   etat:1,  etatLabel:  'Cloture'  }
];
const columnsFr = [
...
/*************************** Handler functions ***************************/
    ...
    return (
        <div className={classes.formStyleP}>
            ...
            {(modalOpen >0 && modalOpen<4) && <AddClassMeeting currentPpId={CURRENT_PROF_PP_ID} currentPpLabel={CURRENT_PROF_PP_LABEL} currentClasseLabel={optClasse[optClasse.findIndex((classe)=> classe.value == CURRENT_CLASSE_ID)].label} currentClasseId={CURRENT_CLASSE_ID} formMode= {(modalOpen==1) ? 'creation': (modalOpen==2) ?  'modif' : 'consult'}  actionHandler={(modalOpen==1) ? addClassMeeting : modifyClassMeeting} cancelHandler={quitForm} />}
