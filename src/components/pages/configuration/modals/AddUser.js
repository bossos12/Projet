...
function AddUser(props) {
    ...
    return (
        <div className={classes.formStyle}>
            {props.formMode=='modif'&&currentUiContext.formInputs[14]&&<div><input className={classes.inputRowLeft} type="checkbox" defaultChecked checkbox={"is_active"} id="is_active"/> Actif?</div>}
            {props.formMode=='modif'&&currentUiContext.formInputs[14]==false&&<div><input className={classes.inputRowLeft} type="checkbox" checkbox={"is_active"} id="is_active"/> Actif?</div>}
            ...
            { (()=>{
                    ...
                    ligne.push(<div className={classes.inputRowLeft} key={"key_ens"}>
                        <input type="checkbox" checkbox="check" defaultChecked id={"checkbox_ens"}/><b>Enseignant</b><br /> </div>)
                        :
                        ligne.push(<div className={classes.inputRowLeft} key={"key_ens"}>
                        <input type="checkbox" checkbox="check" id={"checkbox_ens"}/><b>Enseignant</b><br /> </div>);
