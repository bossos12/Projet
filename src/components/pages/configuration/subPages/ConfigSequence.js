    ...
    function addNewSequence(e) {       
        ...
        var sequ = getFormData();
            ...
            axiosInstance.post(`create-sequence/`, {
                    id:sequ.id, 
                    libelle:sequ.libelle,
                    id_trimestre:sequ.id_tr,
                    date_deb:sequ.date_deb,
                    date_fin:sequ.date_fin,
                    is_active:sequ.is_active,
                    numero:0,
