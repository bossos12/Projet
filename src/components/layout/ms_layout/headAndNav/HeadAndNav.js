    ...
    return (
        <header className={getCurrentTheme()}> 
                ...
                <nav className={getCurrentTheme() + ' ' + getCurrentHeaderBarTheme() }>
                    <div className='nav-wrapper'>
                        ...
                        <ul className="right" style={{marginTop:'1vh'}}>
                            {(currentAppContext.enableProfiles["SCOLARITE"]=='1') ?
                                <li id='menuLi0' className={classes.menuLi1 +' '+ getCurrentThemeActiveMenuBgClr() + putActiveClass('menuLi0')}>
                                    <Link to='scolarite' className={classes.rowDisplay} onClick={()=>toggleActiveMenu('menuLi0')} > < img src="images/scolariteP.png"  className={classes.imageMargin0}  alt="my image"/></Link>
                                </li>
                                :
                                null
                            }

                            {(currentAppContext.enableProfiles["FINANCE"]=='1') ?
                                <li id='menuLi1' className={classes.menuLi1 +' '+ getCurrentThemeActiveMenuBgClr() + putActiveClass('menuLi1')}>
                                    <Link to='economat-et-financePage' className={classes.rowDisplay} onClick={()=>toggleActiveMenu('menuLi1')}> < img src="images/monei.png"  className={classes.imageMargin01} alt="my image"/></Link>
                                </li>
                                :
                                null
                            }

                            {(currentAppContext.enableProfiles["STATS"]=='1') ?

                                <li id='menuLi2' className={classes.menuLi2 + ' '+ getCurrentThemeActiveMenuBgClr() + putActiveClass('menuLi2')}>
                                    <Link to='stats-et-monitoringPage' className={classes.rowDisplay} onClick={()=>toggleActiveMenu('menuLi2')}>< img src="images/monitoring.png" className={classes.imageMargin01}  alt="my image"/></Link>
                                </li >
                                :
                                null
                            }
                            ...
                            {(currentAppContext.enableProfiles["IMPRESSIONS"]=='1') ?
                            ...
                            {(currentAppContext.enableProfiles["COMM_PARENT"]=='1') ?
                            ...
                            {(currentAppContext.enableProfiles["EXTRAS"]=='1') ?
                            ...
                            {(currentAppContext.enableProfiles["CONFIG"]=='1') ?
            ...
            <div className= {getCurrentWidgetTemplateStyle()+ ' '+ getWidgetContentStyle() }>
                ...
                <div id='en' onClick={logouthandler} className={classes.langButton}>
