...
function FormLayout(props){
    ...
    function getFormTitle(){
        ...
        switch(props.formCode){
            //----SCOLARITE ----
            case '1':  return    t('enreg_student');
            case '2':  return    t('consult_list_M');
            case '3':  return    t('changemnt_class_M');
            case '4':  return    t('generate_card_M');
            ...
            case '18':  return   t('Gen_bulletin_M');
            ...
            case '51':  return   'Suivi des fiches de progression';
            case '52':  return   "Consultation de l'emploi de temps";
    ...
    function getFeatureLogo() {
        ...
        switch(props.formCode){
            ...
            case '51':  return  'images/FicheProgession.png';
            case '52':  return  'images/Schedule.png';
